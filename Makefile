...
libed:
	...
	gcc -ggdb -c $(SRC)/funcionalidade_11.c -I $(HDR) -o $(OBJ)/funcionalidade_11.o
	gcc -ggdb -c $(SRC)/funcionalidade_12.c -I $(HDR) -o $(OBJ)/funcionalidade_12.o
	gcc -ggdb -c $(SRC)/funcionalidade_13.c -I $(HDR) -o $(OBJ)/funcionalidade_13.o
	gcc -ggdb -c $(SRC)/funcionalidade_14.c -I $(HDR) -o $(OBJ)/funcionalidade_14.o
